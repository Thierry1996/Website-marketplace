...
export const metadata: Metadata = {
  title: "Testimonials",
  description: "What 10,000+ vendors say about running their business on Marketly.",
};
...
const extended = [
  ...
  { name: "Halima R.", role: "Yoga instructor, Lagos",   body: "First 50 bookings came from the marketplace itself — that paid for the year of Marketly in week three.",                                                          avatarGradient: "linear-gradient(135deg,#06B6D4,#8B5CF6)", rating: 5 },
  ...
  { name: "Eli K.",    role: "Funnel builder",           body: "I've shipped 4 client storefronts this quarter using Marketly Studio. Every single one converts above industry average.",                                          avatarGradient: "linear-gradient(135deg,#8B5CF6,#EC4899)", rating: 5 },
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        description="From solo creators to multi-location service businesses, here's what running on Marketly actually feels like — in their words."
        align="center"
      />
